...
export default function OffersCarousel() {
  ...
  // Buscar produtos em promoção do banco
  useEffect(() => {
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">
              Principais ofertas do mês de{" "}
              <span className="text-blue-600">{obterMesAtual()}</span> para você
            </h2>
          </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2 animate-fade-in-delay">
            {produtos.length} produtos em promoção especial
          </p>
        </div>
        ...
        >
          ...
          {produtosDuplicados.length > visibleCards && (
            ...
            >
              <ChevronRightIcon className="w-6 h-6 text-gray-600 group-hover:text-blue-600 group-hover:scale-110 transition-all duration-300" />
            </button>
          )}
              ...
              {produtosDuplicados.map((produto, index) => {
                ...
                return (
                  <div
                    ...
                    className={`flex-shrink-0 h-[520px] bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.02] transition-all duration-500 group cursor-pointer animate-fade-in-up flex flex-col relative before:absolute before:inset-0 before:bg-gradient-to-t before:from-transparent before:to-transparent hover:before:from-blue-500/5 hover:before:to-transparent before:transition-all before:duration-500`}
                    style={{
                  ...
                  >
                    ...
                    {/* Imagem do Produto */}
                    <div className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden flex-shrink-0 group-hover:bg-gradient-to-br group-hover:from-blue-50 group-hover:to-blue-100 transition-all duration-500">
                      <img
                    ...
                    <div className="p-4 relative flex-1 flex flex-col min-h-0 group-hover:bg-gradient-to-b group-hover:from-transparent group-hover:to-blue-50/30 transition-all duration-500">
                      {/* Conteúdo Superior */}
                      <div>
                        {/* Título */}
                        <h3 className="font-bold text-gray-900 mb-3 line-clamp-2 text-sm leading-tight min-h-[2.5rem] group-hover:text-blue-700 transition-all duration-300 group-hover:scale-[1.02]">
                        ...
                        <div className="space-y-2 min-h-[4.5rem]">
                          {produto.promocao_mes && produto.preco_promocao ? (
                            <>
                              ...
                              {/* Preço Novo */}
                              <div className="text-xl font-bold text-blue-600 transition-all duration-300 group-hover:text-blue-700 group-hover:scale-105">
                            ...
                            <div className="text-xl font-bold text-gray-900 transition-all duration-300 group-hover:text-blue-700 group-hover:scale-105">
                              {formatarMoeda(produto.preco)}
                            </div>
                          )}
                        </div>
